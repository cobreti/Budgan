    ...
    themes: {
      'blue-dark': {
        ...
        colors: {
          ...
          'on-surface-variant': '#B3B3B3', // Medium light secondary text
          outline: '#4A4A4A' // Medium gray borders
        }
      },
      'blue-light': {
        dark: false,
        colors: {
          ...
          secondary: '#263575', // Dark grey for contrast
          ...
          success: '#4CAF50',
          warning: '#FFC107',
          'on-surface': '#2f4a88', // Dark text on light surface
          'on-surface-variant': '#395276', // Medium dark secondary text
          outline: '#D1D5DB' // Light gray borders
        }
      }
    }
  },
